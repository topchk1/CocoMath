...
public class HardGameActivity extends AppCompatActivity implements SensorEventListener {
    ...
    public class MyCountDownTimer extends CountDownTimer {
        ...
        public void onFinish() {
            counter++;
            Intent intent2 = new Intent(HardGameActivity.this, GameOverActivity.class);
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        Intent intent = new Intent(HardGameActivity.this, GameOverActivity.class);
        TextView yourscore = (TextView) findViewById(R.id.scoretv);
        String value = yourscore.getText().toString();
    ...
    public void score() {
        ...
        editor.putInt("lastscorehard", score);
        editor.apply();
    }
